    ...
    <section className="relative min-h-screen flex items-center overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center w-full">
        ...
        <p className="max-w-3xl mx-auto text-gray-500 mb-10 leading-relaxed">
          Frontend Developer specializing in Legacy System Migration.
          Building scalable, secure web architectures backed by a Certified
        ...
        <div className="flex justify-center gap-4">
          <Link
            to="/projects"
            className="px-8 py-3 bg-blue-600 text-white font-semibold rounded-xl hover:bg-blue-700 transition shadow-lg shadow-blue-200 flex items-center gap-2"
          >
          ...
          <Link
            to="/contact"
            className="px-8 py-3 bg-white text-blue-600 font-semibold rounded-xl border border-blue-200 hover:bg-blue-50 transition"
          >
            Contact Me
          </Link>
        </div>
